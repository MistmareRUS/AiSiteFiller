        ...
        var requestBody = new OpenAiChatRequest
        {
            ...
            Messages = new[]
            {
                new OpenAiMessage { Role = "system", Content = "Ты — профессиональный технический копирайтер, эксперт по гаджетам и умному дому. " +
                    ...
                    "В конце описания каждого гаджета и в таблице 'Где купить' обязательно вставляй заглушку строго в следующем формате:" +
                    "[CPA_LINK_PLACEHOLDER:||| БРЕНД_И_ТОЧНАЯ_МОДЕЛЬ_ТОВАРА |||]" +
                    "Пример: [CPA_LINK_PLACEHOLDER:||| Amazon Echo Show 10 |||].Внутри пайпов должно быть только точное название товара без лишних символов!"
                },
